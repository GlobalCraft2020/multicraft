...
wget -N -P ./jar https://raw.githubusercontent.com/GlobalCraft2020/minecraft/master/minecraft/vanilla/vanilla-1.8.4.jar.conf
chown minecraft:minecraft ./jar/vanilla-1.8.4.jar.conf
